...
const services = [
  "Comprehensive engineering course assistance",
  "Expert guidance on engineering principles and practices",
  "Support for assignments, projects, and exams",
        ...
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          <div className="text-center space-y-4">
            <h1 className="text-3xl sm:text-4xl font-bold text-[#0A66C2]">
              Engineering Class Help - Expert Support
            </h1>
            <p className="text-gray-600 max-w-3xl mx-auto text-sm sm:text-base">
              ...
              , we provide professional assistance for engineering students.
              Whether you're struggling with concepts, need help with
              assignments, or preparing for exams, our experts are here to
              support you.
            </p>
          </div>
          ...
          <div>
            <h2 className="text-2xl font-semibold text-[#0A66C2] mb-4">
              Our Engineering Class Help Services Include:
            </h2>
          ...
          <div className="text-center space-y-6">
            <h2 className="text-2xl font-semibold text-gray-800">
              Ready to Excel in Your Engineering Class?
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto text-sm sm:text-base">
              Don’t let engineering concepts overwhelm you. Book a free
              consultation today and get expert guidance to succeed in your
              class.
            </p>
            <CallToActionButton />
          </div>
...
export default EngineeringClassHelp;
