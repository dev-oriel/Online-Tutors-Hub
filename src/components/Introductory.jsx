      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
          ...
          <p>
            ...
            timely delivery — with 24/7 support at your fingertips.
          </p>

          <p>
            We’re proud to offer affordable, flexible payment plans designed to
            accommodate every budget. And yes — you can absolutely pay someone
            to take your online class, quiz, or exam. That’s what we’re here
            for.
          </p>

          <p>
            Our commitment is simple: make your academic journey easier and more
